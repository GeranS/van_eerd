...
#command = "detect.py --weights ./weights/last.pt --img 640 --conf 0.3 --source ./test_images/"
#command = "detect.py --weights ./yolov5l.pt --img 640 --conf 0.3 --source ./test_images/"
#command = "detect.py --weights ./yolov5l.pt --img 640 --conf 0.3 --source 0"
#os.system(command)
...
parser.add_argument('--conf-thres', type=float, default=conf_lvl, help='object confidence threshold')
